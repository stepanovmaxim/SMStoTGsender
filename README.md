Простое и надежное приложение для автоматической пересылки входящих SMS в Telegram. Позволяет читать банковские уведомления и коды подтверждения (2FA) с другого устройства. Поддерживает фильтрацию по отправителю. Ваши данные (Токен и ID) хранятся только на телефоне.
...
Important: To prevent Android from killing the app in the background, enable Autostart and set battery usage to Unrestricted in your phone settings.
...
Importante: Para evitar que Android cierre la aplicación en segundo plano, activa el Inicio Automático y configura el uso de batería en Sin Restricciones (Unrestricted).
